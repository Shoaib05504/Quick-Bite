...
import { FaUser, FaPhone, FaMapMarker, FaEdit, FaLock, FaPlus, FaSignOutAlt, FaStar, FaBolt, FaClock, FaCheckCircle, FaBell, FaCog, FaShare, FaDownload, FaShoppingCart, FaTrash, FaHome, FaBriefcase, FaGraduationCap, FaEye, FaEyeSlash, FaSpinner } from 'react-icons/fa';
import { profileAPI, addressAPI, notificationAPI } from '../../services/apiService';
...
const ProfileDashboard = () => {
  ...
  const [userProfile, setUserProfile] = useState({
    ...
    memberBadge: 'Gold',
    profileImage: 'https://i.ibb.co/RDkh4Cw/profile-default.jpg',
  ...
  const [addresses, setAddresses] = useState([
    { id: 1, type: 'Home', address: '123 Main Street, Delhi', icon: <FaHome /> },
    { id: 2, type: 'College', address: '456 Campus Road, Delhi', icon: <FaGraduationCap /> },
    { id: 3, type: 'Office', address: '789 Business Park, Gurgaon', icon: <FaBriefcase /> },
  ]);
  ...
  const handleRedeemPoints = () => {
    toast.success('Redeem Points feature coming soon! 🎁');
  };

  const handleViewCoupons = () => {
    toast.success('View Coupons feature coming soon! 🎟️');
  };
  ...
  const handleSettings = () => {
    toast.success('Settings panel coming soon! ⚙️');
  };

  const handleShare = () => {
    toast.success('Share profile coming soon! 📤');
  };

  const handleDownload = () => {
    toast.success('Download profile coming soon! ⬇️');
  };
  ...
  if (loading && !userProfile.email) {
    return (
      <div className="profile-dashboard" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
        <motion.div
          animate={{ rotate: 360 }}
      ...
      <nav className="premium-navbar">
        <div className="navbar-container">
          ...
          <div className="navbar-right">
            <form className="search-bar" onSubmit={(e) => { e.preventDefault(); toast.success('Search functionality coming soon! 🔍'); }}>
...
<div className="QuickBite-Banner">
  <h2>Craving Something Tasty?</h2>
  <p>
    Order your Favorite meals anytime,anywhere with QuickBite.
    </p>
</div>
      {/* Hero Section */}
            ...
            <div className="rewards-detail glassmorphic">
              ...
              <div className="rewards-info">
                <div className="reward-item">
                  ...
                  <div>
                    <h4>{userProfile.memberBadge} Member</h4>
        ...
        <div className="modal-overlay" onClick={() => setPasswordModal(false)}>
          ...
          >
            ...
            <form className="edit-form">
              ...
              <div className="form-actions">
                <button type="button" className="btn-cancel" onClick={() => setPasswordModal(false)} disabled={loading}>
                  Cancel
                </button>
                <motion.button 
                  type="button" 
      ...
      {addressModal && (
        <div className="modal-overlay" onClick={() => setAddressModal(false)}>
          <motion.div 
            ...
            animate={{ opacity: 1, y: 0 }}
          >
            <button className="modal-close" onClick={() => setAddressModal(false)}>✕</button>
            ...
            <form className="edit-form">
              ...
              <div className="form-actions">
                <button type="button" className="btn-cancel" onClick={() => setAddressModal(false)} disabled={loading}>
                  Cancel
                </button>
                <motion.button 
                  type="button" 
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {loading ? <FaSpinner className="spinner" /> : (editingAddressId ? 'Update Address' : 'Add Address')}
                </motion.button>
              </div>
            </form>
          </motion.div>
